...
- 사용자의 입력된 아이디어(Problem & Solution 정보)만을 활용하여,
다음 필수 분석 리포트를 자동 생성하십시오.
...
-사용자의 입력된 아이디어(Problem & Solution 정보)만을 활용하여, 다음 **추가 분석 요소**를 포함해 **JSON 형식**으로 최종 답변을 작성하십시오. (모든 점수는 **100점 만점** 기준으로 작성합니다.)  
